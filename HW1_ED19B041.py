...
print("Built in functions dont need to import the module. They are already present and can be called simply by function_name(). eg: print()")
print("They are not linked to a any objects. But to call module functions, you have to first import the module. eg: import os")
print("To use the functions in the module, we have to first refer or call the module and then use its fucntion object by (.) operator. eg: math.sin(a)")
